...
public class DictionaryBasedEmoticonSentimentAnalysis{
	...
	public static void main(String[] args) throws Exception{
		...
		dictionaries.add((new DictionaryBasedEmoticonSentimentAnalysis()).getClass().getResource("/resources/gazetteer/emoticon/lists.def"));
