...
@CreoleResource(name = "Eurosentimen Analyzer",
comment = "Eurosentimen Analyzer",
helpURL = "https://github.com/gsi-upm/SAGA/",
icon = "/es/upm/dit/gsi/seas/logo_gsi.png")
public class EurosentimenAnalysis extends AbstractLanguageAnalyser {
	 ...
	 */
	private String SentimentValueName = "marl:polarityValue";
	 ...
	 */
	private String EmotionValueName = "onyx:hasEmotionIntensity";
    ...
    public void emotionAnnotation(String eurosentiment, Annotation annotation){
        ...
        try {
            ...
            try{
                ...
                JSONObject jsonObject2 = (JSONObject) jsonObject.get("results");
                // We take entries
                if(jsonObject2.get("entries") instanceof JSONObject){
                    JSONObject entries = (JSONObject) jsonObject2.get("entries");
                ...
                }else if(jsonObject2.get("entries") instanceof JSONArray){
                    JSONArray entries = (JSONArray) jsonObject2.get("entries");
    ...
    public String getSentimentValueName() {
        return SentimentValueName;
    }
    
    @Optional
    @RunTime
    @CreoleParameter(comment = "")
    public void setSentimentValueName(String sentimentValueName) {
        SentimentValueName = sentimentValueName;
    }
    ...
    public String getEmotionValueName() {
        return EmotionValueName;
    }
    
    @Optional
    @RunTime
    @CreoleParameter(comment = "")
    public void setEmotionValueName(String emotionValueName) {
        EmotionValueName = emotionValueName;
    }
